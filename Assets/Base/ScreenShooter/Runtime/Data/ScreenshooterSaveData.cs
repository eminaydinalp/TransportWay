...
public class ScreenshooterSaveData {
	...
	public List<ScreenshotData> screenshoots = new List<ScreenshotData>(1) {
		new ScreenshotData("iphone5", new Vector2(1242, 2208)),
		new ScreenshotData("iphone6", new Vector2(1242, 2688)),
		new ScreenshotData("ipad", new Vector2(1280, 1600)),//{ targetCamera = ScreenshooterTargetCamera.SceneView },
	};
